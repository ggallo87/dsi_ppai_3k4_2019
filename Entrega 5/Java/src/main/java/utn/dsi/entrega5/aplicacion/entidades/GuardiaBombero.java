...
import utn.dsi.entrega5.aplicacion.entidades.guardia_bombero_estados.EnCurso;
import utn.dsi.entrega5.aplicacion.entidades.guardia_bombero_estados.EstadoGuardiaBombero;
...
public class GuardiaBombero {
    ...
    public String mostrarDatos() {
        return "Desde: " + horaDesde + ", Hasta: " + horaHasta + ".\nDNI Bombero: " + bombero.getDni() + ".\nEstado Guardia: " + estado.getClass().getSimpleName();
    }
