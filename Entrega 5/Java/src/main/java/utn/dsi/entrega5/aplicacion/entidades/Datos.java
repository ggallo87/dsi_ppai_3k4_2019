...
/**
 * Clase que contiene datos precargados.
 *
 * Esta clase es singleton por lo que su única instancia puede ser accedida
 * desde cualqueir parte del software.
 */
public class Datos {
    ...
    public String mostrarDatosUltimaAsistencia() {
        return guardiasBombero.get(guardiasBombero.size() - 1).mostrarDatos();
    }
